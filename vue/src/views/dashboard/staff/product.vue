<script setup>
	...
	import Cruds from "@/components/dashboard/staff/cruds/product/views/index.vue";
</script>
<template>
	<div>
		<div class="px-5 mt-5">
			<BradcumpWidget
				...
				:items="[{ label: 'Library', route: '/staff' }]"
			/>
		</div>
		<div class="px-5 mt-5">
			<div class="card">
				<div class="card-header flex justify-between">
					<div class="flex-none flex items-center">
						<h6><i class="pi pi-sparkles" /> <span>Product Setting</span></h6>
					</div>
...
<script>
	...
	import { MainData } from "@/components/dashboard/staff/cruds/product/controller";
