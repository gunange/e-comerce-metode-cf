<script setup>
	...
	import { sidebar, navbar } from "@/components/dashboard/admin/config.ts";
</script>
...
<script>
	...
	import { Controller as UserStorageController } from "@/components/dashboard/admin/controller.ts";
